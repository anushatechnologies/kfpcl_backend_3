...
import com.project.kfpcl_exports.admin.model.CheckoutSettings;
import com.project.kfpcl_exports.admin.model.Policy;
import com.project.kfpcl_exports.admin.repository.CheckoutSettingsRepository;
import com.project.kfpcl_exports.admin.repository.PolicyRepository;
...
public class SettingsAndPolicyController {
    ...
    @GetMapping({"/policies/{type}", "/api/policies/{type}"})
