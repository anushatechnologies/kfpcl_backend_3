...
import com.project.kfpcl_exports.admin.dto.AuthResponse;
import com.project.kfpcl_exports.admin.dto.LoginRequest;
import com.project.kfpcl_exports.admin.dto.PasswordChangeRequest;
...
public class AuthController {
    ...
    /**
     * Refresh â€” No token needed. Always returns success.
     */
    @PostMapping("/refresh")
    ...
    /**
     * Logout â€” No token to invalidate. Just returns success.
     */
    @PostMapping("/logout")
    ...
    /**
     * Change Password â€” updates password in MySQL.
     */
    ...
    /**
     * Prepare Password Reset â€” resets password directly in MySQL.
     */
